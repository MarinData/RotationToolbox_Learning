...
% to -90 degrees around the X, Y and Z axis.

%The script first plots the example sensor data, then processes the data through the algorithm and
...
% Using MadgwickAHRS implementation of MahonyAHRS
